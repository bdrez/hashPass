...
To illustrate the differnece i pasted my test case dictionary bellow. Both values are the hashed verision of '123'. The first value used MD5 algorithm and the second value used SHA256.
